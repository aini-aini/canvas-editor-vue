...
import type { IMargin } from '../../interface/Margin'
import type { ILocationPosition } from '../../interface/Position'
import type { IRange, RangeContext, RangeRect } from '../../interface/Range'
import type { IReplaceOption, ISearchResultContext } from '../../interface/Search'
import type { ITextDecoration } from '../../interface/Text'
import type {
...
import type { INavigateInfo, Search } from '../draw/interactive/Search'
...
import type { IAreaBadge, IBadge } from '../../interface/Badge'
import type { IRichtextOption } from '../../interface/Command'
...
export class CommandAdapt {
  ...
  public insertElementList(
    ...
    console.log('[CommandAdapt.insertElementList] 插入元素列表:', cloneElementList);
