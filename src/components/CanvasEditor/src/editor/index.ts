...
export interface IEditorData {
  header?: IElement[]  // 页眉元素数组(可选)
  main: IElement[]     // 主体内容元素数组(必需)
  footer?: IElement[]  // 页脚元素数组(可选)
}
*/
...
import { IAiWritePlugin } from '../plugins/ai_write/types'
